       ...
       <!-- <div slot="searchBox">
        ...
        <div slot="columns">
            ...
            <el-table-column align="center" v-else-if="col.type === 'text'" :formatter="col.formatter" :prop="col.field" :label="col.label" :width="col.width">
                <template slot-scope="scope">
                    <a @click="setContent(scope.row[scope.column.property])"><p class="cell" v-html="scope.row[scope.column.property]"></p></a>
                </template>
            </el-table-column>
    ...
    <el-dialog title="回复" :visible.sync="dialogVisible">
        <el-form :status-icon="true" ref="form" :rules="validRule" :model="editInfo" label-width="80px" size="medium">
            ...
            <el-form-item label="评论内容">
                <el-input v-model="editInfo.contentPre" auto-complete="off"></el-input>
            </el-form-item>

            <el-form-item hidden label="被回复评论id">
                <el-input v-model="editInfo.originId" auto-complete="off"></el-input>
            </el-form-item>
            <el-form-item hidden label="文章id">
                <el-input v-model="editInfo.artId" auto-complete="off"></el-input>
            </el-form-item>
