...
<div class="app-container">
        ...
        <div slot="columns">
            ...
            <el-table-column label="操作" align="center" width="250">
                <div slot-scope="scope">
                    <el-button-group>
                        <!-- <el-button size="mini" type="primary" @click="doGrade(scope.row)">设排序分</el-button> -->
                        ...
                        <!-- <el-button size="mini" type="info"  @click="toTop(scope.row)">置顶</el-button> -->
    ...
    <el-dialog title="设排序分" :visible.sync="gradeShow">
        ...
        <el-input v-model="grade" placeholder="请输入帖子ID" style="width:250px;margin-top:10px;" clearable></el-input>
...
export default {
    ...
    data() {
        ...
        return {
            ...
            baseUrl: BASE_URL,
            api: {
                list:'/post/list/published?source=1',
                delete: "/post/remove",
            ...
            cols: [{
                ...
                // {field: "postScore",label: "排序分",width:'75px'},
                {
                    field: "createTime",
                    label: "发表时间",
                },
    ...
    methods: {
        ...
        //     this.$http.post({
        //         isJson:false,
        //         url:'/post/cancelRecommend/' + row.postId,
        //         params:{},
        //         success: res=>{
        //             if(res.code == 0 && res.data == 1){
        //                 this.$message({
