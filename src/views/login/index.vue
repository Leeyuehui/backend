<template lang="html">
  <div class="login-container" @keyup.enter="submitForm('ruleForm2')">
    <el-form v-loading.body="isLoading"  element-loading-text="正在登陆中..." element-loading-background="rgba(0, 0, 0, 0)" :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="100px"
             class="demo-ruleForm">
      <h3 class="title">小抱枕社区 —— 后台管理系统</h3>
