...
<div class="app-container">
    <el-form :inline="true"  class="demo-form-inline">
        <div style="margin:10px 0;">
            <el-button type="primary" @click="notDelete">不删除</el-button>
            <el-button type="danger" @click="commentsDelete">删除</el-button>
        </div>
        ...
        <el-table v-loading="loading" element-loading-text="正在加载中" :data="tableData" :border="true" v-if="tableData" style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="operateReason" label="删除理由" align="center" width="100px"></el-table-column>
            <el-table-column prop="commentId" label="评论ID" align="center" width="80"></el-table-column>
            ...
            <el-table-column prop="content" label="文本" align="center">
                <template slot-scope="scope">
                    <el-button type="text" class="hand" @click="text(scope.row)">{{scope.row.content}}</el-button>
                </template>
            </el-table-column>
            ...
            <el-table-column prop="userName" label="从属于帖子" align="center">
                <template slot-scope="scope">
                    <router-link :to="{name:'post',query:{postId:scope.row.postId}}"><div style="color:#87C3E6;">{{scope.row.postId}}</div></router-link>
                </template>
            </el-table-column>
            <el-table-column prop="userName" label="从属于评论" align="center">
                <template slot-scope="scope">
                    <router-link type="text" :to="{name:'searchComment',query:{comId:scope.row.parentId}}"><div style="color:#87C3E6;">{{scope.row.parentId}}</div></router-link>
                </template>
            </el-table-column>
