...
<div class="app-container">
    <my-table :api="api" :cols="cols" ref="table" :idField="idField" :opeBtn="false" @refresh="refresh" :searchInfo="searchInfo" :editInfo="editInfo" @beforeCommit="beforeCommit" @handleAdd="handleAdd" @handleEdit="handleEdit">
...
export default {
    ...
    data() {
        ...
        return {
            ...
            api: {
                list: "f10104?type=1",
                delete: "f10102?type=1",
                add: "f10101?type=1",
                edit: "f10103?type=1",
                search: "f10104?type=1",
            },
            // id 字段
            idField: "artId",
            artIdVal:'',
